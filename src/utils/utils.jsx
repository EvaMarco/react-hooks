...
import { faSkullCrossbones, faHeartbeat, faQuestion } from '@fortawesome/free-solid-svg-icons';
import { faVenus, faMars, faGenderless, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
